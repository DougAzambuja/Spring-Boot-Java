...
public class ViagemDto implements Serializable {
    ...
    @Length(min = 3, max = 40, message = "Local de Destino deve ter entre 3 e 40 caracteres")
    ...
    @NotNull(message = "Data de Partida é uma informação obrigatória")
    ...
    public String toString(){
        return "ViagamDto [id=" + id + ", localDeDestino=" + localDeDestino + ", dataPartida=" + dataPartida
